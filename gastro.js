...
const T = {
  de: {
    ...
    ignore: 'Ist mir egal', reactivate: 'Wieder werten',
  ...
  en: {
    ...
    ignore: 'Skip this', reactivate: 'Count again',
...
function drawCurators() {
  ...
  document.getElementById('kur-sub').textContent = allActive ? t('allVoices') : mineActive ? t('optMine') : (k ? kname(k) : '');
}
