...
const T = {
  de: {
    ...
    ignore: 'Ist mir egal', reactivate: 'Wieder werten', change: 'ändern', ratingsBy: 'Bewertungen von:', whole: 'ganz', skip: 'Überspringen', allShort: 'Alle', avg: 'Durchschnitt aller {n} Stimmen',
  ...
  en: {
    ...
    ignore: 'Skip this', reactivate: 'Count again', change: 'change', ratingsBy: 'Ratings by:', whole: 'all of', skip: 'Skip', allShort: 'Everyone', avg: 'Average of all {n} voices',
